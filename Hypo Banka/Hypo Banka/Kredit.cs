...
namespace Hypo_Banka
{
    public class Kredit
    {
        ...
        {
            return "Kredit koji se treba vratiti najkasnije na dan " + (rokOtplate.Day < 10 ? "0" : "") + rokOtplate.Day + "." + (rokOtplate.Month < 10 ? "0" : "") + rokOtplate.Month + "." + rokOtplate.Year + ". godine ima preostali iznos od "
